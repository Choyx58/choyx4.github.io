    ...
    <body>
        ...
        <main class="pt-4">
            <div class="body-text pt-5">
                                ...
                                <div class="card-body">
                                    <div class="table-resposive">
                                        <table class="table table-borderless fuenteFav" style="width: 100%; max-width: 500px; height: auto;">
                                            <!-- Aquí utilizas las variables recibidas de la URL -->
                                            <tr>
                                                <td><b>Cantidad</b></td>
                                                <td><b><?php echo isset($_GET['cantidadProductos']) ? $_GET['cantidadProductos'] : 'N/A'; ?></b></td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <th><?php echo isset($_GET['totalPrecios']) ? '$' . number_format($_GET['totalPrecios'], 2) . ' MXN' : 'N/A'; ?></th>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-resposive">
                                    <table class="table table-borderless fuenteFav" style="width: 100%; max-width: 500px; height: auto;">
                                        ...
                                        <tr>
                                            <td>Total</td>
                                            <td><b><?php echo isset($_GET['totalPrecios']) ? '$' . number_format($_GET['totalPrecios'], 2) . ' MXN' : 'N/A'; ?></b></td>
                                        ...
                                        <tr style="font-size: 1.3rem;">
                                            ...
                                            <th style="border-top: 2px solid black;"><?php echo isset($_GET['totalPrecios']) ? '$' . number_format($_GET['totalPrecios'], 2) . ' MXN' : 'N/A'; ?></th>
                                        </tr>
                                    </table>
                                </div>
                                <div id="paypal-button-container"></div>
                ...
                <div class="pb-4 mx-3">
                    <a href="../favorito.php" class="button-link">Regresar</a>
                </div>
            ...
            <form action="detalles.php?&totalPrecios=<?= $precioP ?>&vCodigo=<?= $vCodigo ?>&vNombre=<?= $nombreP  ?>&idColor=<?= $imgP  ?>&idColor=<?= $colorP ?>&vPrecioVenta=<?= $precioVentaP  ?>&idTalla=<?= $tallaP ?>" method="POST">
                    ...
                    <div class="modal-dialog modal-dialog-centered py-5">
                        <div class="modal-content shadow-card border-0">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12 text text-center fs-4">
                                        <span class="text-dark"><b>¡COMPRA REALIZADA CON ÉXITO!</b></span>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer  d-flex justify-content-center">
                                ...
                                <input type="hidden" name="vCodigo" value="<?php echo $vCodigo ?>">
        ...
        <script>
            ...
            document.addEventListener('keydown', function(event) {
                var modal = document.getElementById('compraExito');
            ...
            paypal.Buttons({
                ...
                createOrder: function(data, actions) {
                    return actions.order.create({
                        purchase_units: [{
                            amount: {
                                value: <?php echo isset($_GET['totalPrecios']) ? $_GET['totalPrecios'] : '0.00'; ?>
                            }
                        }]
                    })
                },
